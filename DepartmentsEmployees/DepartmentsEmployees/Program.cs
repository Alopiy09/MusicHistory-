...
namespace DepartmentsEmployees
{
    class Program
    {
        ...
        public static void PrintEmployeeReport(string title, List<Employee> employees)
        {
            ...
            {
                Console.WriteLine($"{title}: ");
                employees.ForEach(employee => Console.WriteLine($"{employee.Id}: {employee.FirstName} {employee.LastName}"));
            } else if (title == "All Employees with departments")
            {
                Console.WriteLine($"{title}: ");
                employees.ForEach(employee => Console.WriteLine($"{employee.Id}: {employee.FirstName} {employee.LastName} Dept: {employee.Department.DeptName}"));
            } else if (title == "All Employees after updating Jane")
            {
                Console.WriteLine($"{title}: ");
                employees.ForEach(employee => Console.WriteLine($"{employee.Id}: {employee.FirstName} {employee.LastName} Dept: {employee.Department.DeptName}"));
            }
